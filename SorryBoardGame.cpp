...
//  SorryBoardGame.cpp
//  05/12/2023
//  Created by Josiah Thacker and Sydney Gargiulo.
//  The Purpose of this program is to play a game of "Sorry". Being able to play with 2-4 people, rolling 2 dice that move you along the playing board or take you back.
#include<iostream>
#include<string>
#include<ctime>
using namespace std;
